...
# Load and preprocess
df = pd.read_csv("/content/drive/MyDrive/3SLite/Comparative Study/Dataset/Combined_CIC_IoT_DIAD_2024.csv")
...
baseline = build_baseline_lstm(input_dim)
optimized = build_optimized_lstm(input_dim)
...
results.to_csv("tensorflow_lstm_comparison.csv")
print(results)
